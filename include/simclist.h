 ...
 */
typedef void *(*element_serializer)(const void *el, uint32_t *serializ_len);
 ...
 */
typedef void *(*element_unserializer)(const void *data, uint32_t *data_len);
 ...
 * list and then return the number of bytes written to the file descriptor.
 *
 * @param l     list to operate
